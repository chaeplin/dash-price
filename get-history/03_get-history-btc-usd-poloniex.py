...
def getdata():
    ...
    url = "https://poloniex.com/public?command=returnChartData&currencyPair=USDT_BTC&start=" + startepoch + "&end=9999999999&period=300"
    ...
    try:
        ...
        if r:
            ...
            filetow = 'btc_poloniex_history.log'
